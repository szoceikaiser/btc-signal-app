...
**Aufwaerts-Beteiligung: 50 %** — in den 5 steigenden Monaten legte Bitcoin zusammen +53.0 % zu, die Engine +26.6 %.
...
|---|---|---|---|---|---|
| ohne Futures-CVD (Stand bisher) | 35% | 23% | +35.3 % | -9.9 % | 247 |
...
|---|---|---|---|---|---|
| heute (nur Binance) | 35% | 23% | +35.4 % | -9.9 % | 244 |
| **+OI aggregiert** | 35% | 23% | **+37.4 %** | -9.9 % | 235 |
| **+OI +Liquidationen aggregiert** | 41% | 23% | **+39.7 %** | -9.9 % | 232 |
...
Warum: Oben werden 75 Varianten gegen EIN Zeitfenster verglichen. Die beste von vielen sieht immer besser aus als sie ist — wie der Beste von 75 Muenzwerfern. Deshalb laeuft hier jede Variante noch einmal getrennt in zwei Haelften. **Liegt dieselbe Variante in beiden Haelften vorne, ist der Vorteil vermutlich echt. Kippt die Rangfolge, war es Zufall.**
...
|---|---|---|---|---|
| nur Long (Basis) | +4.2 % | 72. | +5.0 % | 35. |
| +Kaufleiter | +8.9 % | 69. | +5.2 % | 34. |
| +Flush core | +21.8 % | 27. | -1.8 % | 61. |
| LIVE: nur Long +Kaufleiter +Flush core | +26.1 % | 1. | -1.6 % | 60. |
| +Kaufleiter +Bed.Stop | +5.8 % | 70. | +6.7 % | 23. |
| LIVE +Rest-Freigabe | +21.2 % | 29. | -3.7 % | 72. |
| LIVE +Stop nachziehen | +24.8 % | 5. | -2.4 % | 62. |
| LIVE +Stop nachziehen +Rest-Freigabe | +21.2 % | 30. | -3.7 % | 73. |
| LIVE +Stop +Liq-Kaskade | +19.6 % | 37. | -3.2 % | 69. |
...
| LIVE +Stop +Warnlicht (kein Kauf in ungesunden Abverkauf) | +23.4 % | 14. | -2.4 % | 63. |
| LIVE +Stop +Flow-Pruefung am 0.5-Level | +25.4 % | 3. | -0.8 % | 52. |
| LIVE +Stop +Sperre 48 h nach Stop | +21.9 % | 26. | -0.7 % | 51. |
| LIVE +Stop +Mindest-Stopabstand 2 % | +20.9 % | 31. | +4.8 % | 37. |
| LIVE +Stop +Sperre 48 h +Mindestabstand 2 % | +14.7 % | 57. | +4.8 % | 38. |
| LIVE +Stop +alle vier neuen Hebel | +17.3 % | 49. | -1.0 % | 54. |
| LIVE +Stop +Mindestabstand 2 % +Liq-Konfluenz | +19.9 % | 35. | +8.0 % | 19. |
...
| LIVE bis 26.09.2026 (ohne Bein-Richtung) | +20.0 % | 34. | +4.3 % | 42. |
...
|---|---:|---:|---:|---:|---:|
| **Live: Rueckeroberung, 1 Kerze** | +35.4 % | -9.9 % | +23.6 % | +9.5 % | 9 |
...
|---|---:|---:|---:|---:|---:|
| **Live (alt)** | +35.4 % | -9.9 % | +23.6 % | +9.5 % | 244 |
| Muster 2 in Dollar (usd) | +35.4 % | -9.9 % | +23.6 % | +9.5 % | 244 |
...
| Variante | Rendite | Rueckgang | H1 | H2 | Signale |
|---|---:|---:|---:|---:|---:|
| **Live (usd)** | +35.4 % | -9.9 % | +23.6 % | +9.5 % | 244 |
| OI in Kontrakten (btc) | +35.4 % | -9.9 % | +23.6 % | +9.5 % | 227 |
