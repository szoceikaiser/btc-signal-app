...
| Tests | 7.013 in fünf Dateien | **444 Tests**, alle müssen grün sein |
| `engine\sabotage_e*.py` | 843 in fünf Dateien | Sabotage-Proben: verfälschen den Code Zeile für Zeile und prüfen, dass Tests rot werden. Zusammen 151 Sabotagen |
...
| **Tests** (`tests.yml`) | Push | Hält die 444 Tests grün |
